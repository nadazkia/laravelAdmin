    ...
    !(function (F) {
        ...
        function $(e, t, i, s) {
            for (
                ...
                if (
                    ...
                    (c = c.toUpperCase()),
                    (o =
                        "contains" === i ? 0 <= c.indexOf(t) : c.startsWith(t)))
                )
                    break;
            }
            return o;
        ...
        (c.VERSION = "1.13.2"),
            ...
            (c.prototype = {
                    ...
                    function i(e, t) {
                        ...
                        (O.selectpicker.view.scrollTop = e),
                            !0 === m &&
                                ...
                                O.$menu[0].offsetWidth >
                                    O.sizeInfo.totalMenuWidth &&
                                ((O.sizeInfo.menuWidth =
                                    O.$menu[0].offsetWidth),
                                (O.sizeInfo.totalMenuWidth =
                                    O.sizeInfo.menuWidth +
                                    O.sizeInfo.scrollBarWidth),
                        ...
                        for (var v = 0; v < s; v++) {
                            ...
                            void 0 === u &&
                                e <=
                                    O.selectpicker.current.data[g - 1]
                                        .position -
                                        O.sizeInfo.menuInnerHeight &&
                                (u = v);
                        }
                            ...
                            void 0 !== O.activeIndex &&
                                ((T =
                                    O.selectpicker.current.elements[
                                        O.selectpicker.current.map.newIndex[
                                            O.prevActiveIndex
                                        ]
                                    ]),
                                (D =
                            ...
                            !0 === m &&
                                ...
                                (w =
                                    O.selectpicker.view.position1 > h - 1
                                        ? 0
                                        : O.selectpicker.current.data[h - 1]
                                              .position -
                                          O.selectpicker.current.data[
                        ...
                        if (
                            ...
                            if (C && t) {
                                ...
                                O.selectpicker.view.canHighlight[y] ||
                                    (y =
                                        1 +
                                        O.selectpicker.view.canHighlight
                                            .slice(1)
                                            .indexOf(!0)),
                                    (S =
                                        O.selectpicker.view.visibleElements[y]),
                    ...
                    var M = function (e, t, i, s) {
                        ...
                        V = function (e) {
                            ...
                            if (e.optionContent) s.innerHTML = e.optionContent;
                                ...
                                e.optionSubtext &&
                                    (((t = W.subtext.cloneNode(!1)).innerHTML =
                                        e.optionSubtext),
                                    s.appendChild(t));
                            }
                    ...
                    if (this.options.title && !this.multiple) {
                        ...
                        if (s)
                            (this.selectpicker.view.titleOption.className =
                                ...
                                (i =
                                    void 0 ===
                                        F(t.options[t.selectedIndex]).attr(
                                            "selected"
                                        ) &&
                        ...
                        if ((R++, !t.hasClass("bs-title-option"))) {
                            ...
                            if (
                                    ...
                                    if (!this.previousElementSibling) {
                                        ...
                                        var S = (function (e) {
                                            var t,
                                                ...
                                                s = W.text.cloneNode(!1);
                                            if (
                                                ((s.innerHTML = e.labelEscaped),
                                                e.labelIcon)
                                            ) {
                                                var n = W.whitespace.cloneNode(
                                                    !1
                                                );
                                                ((i = W.span.cloneNode(
                                                    !1
                                ...
                                (T.selectpicker.main.map.newIndex[e] = R),
                                    (T.selectpicker.main.map.originalIndex[R] =
                                        e);
                                var C = N[N.length - 1];
                                C.disabled = v;
                                var O = 0;
                ...
                render: function () {
                    ...
                    for (
                        ...
                        if (
                            ...
                            (i.push(l),
                            (s.length < 100 &&
                                "count" !== e.options.selectedTextFormat) ||
                                1 === i.length)
                        ) {
                            if (
                    ...
                    var h = this.multiple
                        ? s.join(this.options.multipleSeparator)
                        : s[0];
                    if (
                        (50 < i.length && (h += "..."),
                        this.multiple &&
                    ...
                    if (e || (!1 !== this.options.size && !this.sizeInfo)) {
                        ...
                        var t = document.createElement("div"),
                            ...
                            d =
                                this.options.header &&
                                0 <
                                    this.$menu.find("." + q.POPOVERHEADER)
                                        .length
                                    ? this.$menu
                                          .find("." + q.POPOVERHEADER)[0]
                                          .cloneNode(!0)
                                    : null,
                ...
                setMenuSize: function (e) {
                    ...
                    if (
                        (this.options.dropupAuto &&
                            ((r =
                                a * this.selectpicker.current.elements.length +
                                m.vert),
                            ...
                            (!r &&
                                ...
                                (o =
                                    this.selectpicker.main.elements[
                                        n
                                    ]).classList.toggle("selected", t),
                                o.classList.remove("active"),
                                o.firstChild &&
                                    (o.firstChild.classList.toggle(
                                        "selected",
                                        t
                                    ),
                ...
                clickListener: function () {
                    ...
                    t.data("spaceSelect", !1),
                        ...
                        this.$element.on("shown.bs.select", function () {
                            E.$menuInner[0].scrollTop !==
                                E.selectpicker.view.scrollTop &&
                                (E.$menuInner[0].scrollTop =
                                    E.selectpicker.view.scrollTop),
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    c.prop("selected", !1),
                                        ...
                                        E.setSelected(n, !0);
                                !E.multiple ||
                                (E.multiple && 1 === E.options.maxOptions)
                                    ? E.$button.focus()
                                    : E.options.liveSearch &&
                                      E.$searchbox.focus(),
                                    r &&
                ...
                val: function (e) {
                    return void 0 !== e
                        ? (this.$element.val(e).triggerNative("change"),
                          this.$element)
                        : this.$element.val();
                },
                ...
                keydown: function (e) {
                    var t,
                        ...
                        c = (
                            r ? l.closest(".dropdown") : l.closest(N.MENU)
                        ).data("this"),
                        a = c.findLis(),
                        d = !1,
                    ...
                    if (
                        ...
                        void 0 ===
                            (t =
                                !0 === f
                                    ...
                                    : c.selectpicker.current.map.newIndex[
                                          c.activeIndex
                                      ]) && (t = -1),
                            -1 !== t &&
                                ((s =
                                    c.selectpicker.current.elements[
                                        t + m
                        ...
                        e.which === H
                            ? 0 === m && t === a.length - 1
                                ? ((c.$menuInner[0].scrollTop =
                                  ...
                                  (v =
                                      c.selectpicker.current.elements.length -
                                      1))
                                : (d =
                                      (o =
                                          (n = c.selectpicker.current.data[v])
                                              .position - n.height) < u)
                            : (e.which === L || h) &&
                              (0 === t
                            ...
                            (c.activeIndex =
                                c.selectpicker.current.map.originalIndex[v]),
                        ...
                        e.preventDefault(),
                            ...
                            c.selectpicker.keydown.resetKeyHistory.cancel &&
                                clearTimeout(
                                    c.selectpicker.keydown.resetKeyHistory
                                        .cancel
                                ),
                            (c.selectpicker.keydown.resetKeyHistory.cancel =
                        ...
                        for (
                            var x = 0;
                            x < c.selectpicker.current.data.length;
                            x++
                        ) {
                        ...
                        if (w.length) {
                            ...
                            a
                                ...
                                0 <
                                u -
                                    (n = c.selectpicker.current.data[g])
                                        .position
